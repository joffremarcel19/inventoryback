...
@Service
public class PeiServiceImpl extends CRUDImpl<Pei, Integer> implements IPeiService{

	@Autowired
	private IPeiRepo repo;

	@Override
	protected IGenericRepo<Pei, Integer> getRepo() {
		return repo;
	}	
	
	@Override
	public Page<Pei> listarPageable(Pageable pageable) {
		return repo.findAll(pageable);
	}

	@Override
	public List<Pei> listarPeiAnio(Integer anio, Integer idUni) {
		// TODO Auto-generated method stub
		return repo.listarPeiAnio(anio, idUni);
	}
